...
public class MainActivity extends AppCompatActivity {
    ...
    // variable for different components
    ...
    private void getWeatherInfo(String cityName) {
        String url = "http://api.weatherapi.com/v1/current.json?key=ee7cd2403cdc4019b4385746230610&q=" + cityName + "i&aqi=no";
        cityNameTV.setText(cityName);
